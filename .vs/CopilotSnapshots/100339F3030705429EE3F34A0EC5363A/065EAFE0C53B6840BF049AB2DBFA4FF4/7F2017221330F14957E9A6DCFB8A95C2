...
namespace CMS.UI.Services
{
    ...
    public class TokenApiService
    {
        ...
        public async Task<TokenResponseDto?> GetApiTokenAsync(UserSyncApiService.AzureUserInfo azureUser)
        {
            try
            {
                _logger.LogInformation("🔑 Solicitando JWT para: {Email}", azureUser.Email);
